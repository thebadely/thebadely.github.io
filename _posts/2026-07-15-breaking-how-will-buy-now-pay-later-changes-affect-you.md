---
layout: post
title: "Breaking: How will Buy Now Pay Later changes affect you?"
date: 2026-07-15T08:43:15
author: "badely"
categories: [Business]
tags: []
excerpt: "Consumers should be better protected as Buy Now Pay Later lenders now require authorisation to operate."
image: assets/images/5e8368ae6ccf6c365427466c9e665517.jpg
---

According to new developments, Shoppers using Buy Now Pay Later (BNPL) services have stronger rights but some will be refused loans, as new rules come into effect.
...
There are fears that new affordability checks on each BNPL transaction will leave some blocked for the first time, pushing them towards "thrilled" loan sharks instead.
...
But Klarna, the UK's largest provider, disagreed.
...
"Like the [regulator], we expect the new regulation will ultimately lead to growth as it increases consumer trust and confidence."
...
Consumers can claim for refunds and compensation for faulty goods costing more than Â£100 from the BNPL provider (known as section 75), as is already the case with items bought on a credit card
...
"Before you know it, it's thousands. Add in loans, credit cards, bits of finance here and there, and suddenly I owed Â£24,000."
...
Credit reference agency Experian, which already receives data voluntarily from some providers estimated that more than 100 million BNPL transactions were made by 8.5 million customers in 2025, worth more than Â£7bn in spending. 
...
"Interest-free buy now pay later is a simpler, fairer, lower-cost alternative to revolving credit. Robust regulation that gives consumers added confidence and strengthens their access to protections is a good thing," said a spokesman for Klarna, which says the average age of its customers is 38.
