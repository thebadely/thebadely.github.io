---
layout: post
title: "Breaking: Buy now, pay later checks will block some shoppers"
...
Let's dive into the details: Shoppers using buy now, pay later (BNPL) will need to pass stricter affordability checks under new rules coming into force next July.
