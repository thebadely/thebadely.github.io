---
layout: post
title: "Latest: Claude Code users hitting usage limits 'way faster than expected'"
...
Experts revealed that Anthropic says it is looking to resolve an issue which is blocking users of its AI coding tool.
