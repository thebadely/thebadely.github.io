---
layout: post
title: "New: Some tech shares are plunging - what does that mean for the AI revolution?"
date: 2026-07-29T15:32:28
author: "badely"
categories: [Business]
tags: []
...
image: assets/images/1366eeb0f49073f539677a57d21f9bde.jpg
---

Let's dive into the details: Sharp falls in the value of chip makers have stoked investor concerns that the euphoria around artificial intelligence (AI) related companies is fading.
...
Yet these shares still are up threefold and fivefold respectively over the last year, leading many to conclude that some caution and profit taking after such massive gains was inevitable â and indeed healthy.
...
One of the other triggers for the concerns has been a reported breakthrough in the manufacturing process by a Chinese company, potentially making China more self-sufficient in chip design and production.

That has added to lingering concerns that the big AI companies â Meta, Alphabet, Open AI, Anthropic â will find it hard to charge end users enough to justify the hundreds of billions being spent on buying the chips and building the data centres that power the technology.

As a result, firms that have announced big increases in spending on AI have not always been welcomed with the same enthusiasm by investors.

For example, SpaceX â which is predominantly an AI company - has seen its shares fall 14% from its much-hyped debut on the stock market and nearly 50% from its peak in June.

Apple â which has largely sat out the AI arms race â has seen its shares rise 21% over the last month to reclaim its title as the world's most valuable company from chip maker Nvidia.

Meanwhile London's benchmark FTSE 100 index which have some have dubbed the "anti-tech index", briefly touched a record high - one of the few periods in recent years where it has benefited from not being tech-heavy.

Historically it is possible for investors to lose money even if the technology they are backing succeeds.

For example, while railways transformed economies â particularly in the US â plenty of people lost money along the way. Unlike rail tracks â which once built are good for decades â data centres are likely to need upgrading frequently to include the latest and fastest processors.
