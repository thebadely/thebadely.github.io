---
layout: post
title: "Update: Will self-flying planes transform the skies?"
date: 2026-09-01T23:27:35
author: "badely"
categories: [Business]
tags: []
excerpt: "Autonomous crop-spraying aircraft are leading the way in pilot-free flying."
image: assets/images/67850bb7161cc72d5ad1d9a6f112f14f.jpg
---

According to new developments, Pyka's crop dusters are used in the US and Brazil
...
But a quieter race is also under way to deploy self-flying planes, first for jobs like crop spraying and cargo delivery â and eventually, many of their makers hope, carrying passengers too.
...
The take-off, down a runway beside the field, is seamless. About 15 minutes later, after sensing that it is running low on spray â water for today's purposes â the aircraft lands itself for a manual refill and demonstration battery swap. It then takes to the air again to resume spraying precisely where it left off.
...
Windracers wants to launch an autonomous cargo service
...
Supporters say autonomous aircraft could address pilot shortages, remove people from dangerous work such as crop spraying, improve efficiency â for example, by  allowing aircraft to carry more cargo â and cut costs if one operator can oversee many planes.
...
Reliable Robotics is retrofitting planes with its autonomous tech
...
"For a lot of things there's no need to use AIâ¦but for figuring out that six pixels in the distance are an airplane versus some other smudge, it is perfect territory," says Norcia.

The AI dilemma also extends to communicating with air traffic control.

In shared airspace, aircraft must be able to receive, interpret and respond to radio instructions typically via voice.
...
"Our problem is harderâ¦ but we want to move beyond remote piloting," says George.
