---
layout: post
title: "Update: Will your job be replaced by AI? Here are the roles most affected"
date: 2026-07-22T07:40:33
author: "badely"
categories: [Business]
tags: []
...
Let's dive into the details: Will your job be replaced by AI? Here are the roles most affected
...
Nobel prize-winning economists recently warned the world âmust act nowâ, external to ensure that AI leads to rising living standards and not large-scale job displacement, and last month London businesses warned they were struggling to find the skills they need as AI disrupts the jobs market.
...
This measure showed that three years ago, large language models (LLMs) were only able to reliably complete tasks humans took seconds or minutes to do. Now they are increasingly able to complete fairly complex tasks taking an hour or so.
...
There have been astonishing increases in AI use in 2026, and the increase in token use has vastly outweighed the declining âper token costâ.
...
Trillions, and sometimes thousands of trillions of tokens (quadrillions) have been used over the past few months primarily for âagentic useâ, which is for agents that can perform tasks automatically. The problem here is that incredible bills were racked up, so much so that many of those companies have now begun to ration the use of these models.
