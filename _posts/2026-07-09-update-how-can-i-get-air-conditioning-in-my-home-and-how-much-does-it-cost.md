---
layout: post
title: "Update: How can I get air conditioning in my home and how much does it cost?"
date: 2026-07-09T10:00:08
author: "badely"
categories: [Business]
tags: []
excerpt: "As summers in the UK get hotter, is it time for air conditioning to become a permanent feature in most homes?"
image: assets/images/61dad61b8474f15f8306be612424fcb9.jpg
---

According to new developments, As the UK experiences hotter summers and more regular heatwaves, households have been grappling with how to keep sweltering homes as cool as possible.
...
Portable units are the cheapest form of air con, ranging from Â£350 to Â£650 on average, depending on the brand and performance, according to Checkatrade., external

However, as demand has soared in recent weeks some retailers began selling the cooling machines for Â£149, as Lidl did in its middle aisles.

Wall mounted or split air con units can cost between Â£750 and Â£1,100 each, Checkatrade says - but that is just the unit, and does not include the labour and other installation costs, such as hooking it up to the property's electricity fuse board. Installation company Heatable suggests, external a full cost is typically Â£2,000 to Â£3,500, but can go up to Â£6,000 if you want to have it in more than one room.

Ducted air con systems cost the most, between Â£990 and Â£1,750 without installation costs, according to Checkatrade. Fitting the ducting or remedial work to hide it inside properties means it is likely to be more expensive than any of the other systems given the level of work involved. Heatable estimates it to be between Â£5,000 and Â£10,000, depending on the property size, layout and how complex the ductwork needs to be.
...
Following installation, consumer group Which? suggests, external the running costs "vary wildly" and depend on the type of system. 
