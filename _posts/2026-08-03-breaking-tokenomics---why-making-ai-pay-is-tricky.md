---
layout: post
title: "Breaking: Tokenomics - Why making AI pay is tricky"
date: 2026-08-03T23:21:10
author: "badely"
categories: [Business]
tags: []
...
It has been recently reported that The big AI firms sell paid-for versions of their tech
...
While the cost of individual tokens â or the credits used to pay for them - has plummeted in recent years, according to analysis by Goldman Sachs, the number of tokens consumed by businesses, and consumers, has skyrocketed.
...
But companies, and individuals, using AI systems often have a tenuous grasp on just how many tokens they are burning through â until they either run out or get their monthly bill.
...
Firms are struggling to manage their AI costs says Will Venters
...
"People are finding it really hard to manage that costâ¦ it's a non-deterministic output, so it's a non-deterministic value," he said.
