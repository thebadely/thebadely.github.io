---
layout: post
title: "Big News: Pressure builds on Europe's biggest port to be greener"
date: 2026-07-09T23:00:51
author: "badely"
categories: [Business]
tags: []
excerpt: "A lawsuit demands that the Port of Rotterdam moves faster to cut its dependence on fossil fuel firms."
image: assets/images/e4eac251297bf73dcd37bf22db91a52a.jpg
---

Here’s what you need to know: Rotterdam is home to five oil refineries
...
The horizon is dominated by cranes, bulk carriers and container stacks â the visible parts of a vast energy and chemicals hub.
...
According to research by CE Delft, the fossil fuels flowing through the port are ultimately linked to around 600 megatonnes of CO2 a year â many times more than the CO2 output of the Netherlands' biggest airport, Schiphol.
...
Rotterdam's own industrial cluster currently emits about 29 million tonnes of CO2 a year â roughly half of the Netherlands' domestic emissions, says Mark van Dijk, head of external relations at the Port of Rotterdam Authority.

That's the equivalent of tens of thousands of return flights from Amsterdam to Los Angeles. "It's not good," admits van Dijk.

The port has plans to cut the emissions of its own activities
...
"In the short term we're focusing on CCS [Carbon Capture and Storage] â capturing CO2 and storing it in depleted gas fields," van Dijk says, referring to the Porthos project that will pipe industrial emissions offshore.
...
Oscar van Veen is working on cutting emissions at the Port of Rotterdam
...
Their loyalty lies with boardrooms abroad. If the rules in Rotterdam become too tight, they can simply move â as Shell shifted its headquarters to the UK and Unilever left Rotterdam altogether.
...
He is sceptical that any single port authority can drive a full transition on its own. What is needed, he says, is a global level playing field â the kind of framework provided in Europe by the Emissions Trading System and past rules on sulphur in marine fuels.
...
"But their biggest income is still tied to fossil fuel industries," he notes. "It's not simply a switch you turn on or off. A port needs activity as a logistics node â otherwise it's no longer a port. It's a real dilemma."

Rotterdam handles almost as much cargo as UK ports combined
